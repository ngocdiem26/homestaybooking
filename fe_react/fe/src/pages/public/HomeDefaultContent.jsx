...
//   return (
//     <section className="max-w-7xl mx-auto px-4 md:px-8 py-12 border-t border-[#6E473B]/10 animate-fade-in">
      
//       {/* KHÁM PHÁ VIỆT NAM */}
//       <div className="text-left mb-8">
//         <h2 className="font-classic text-2xl md:text-3xl font-bold text-[#2C1E15] mb-1">Khám phá Việt Nam</h2>
//         <p className="text-xs text-gray-400">Chọn địa danh để hiển thị ngay các homestay đặc trưng tại khu vực đó</p>
//       </div>
...
//       {/* HOMESTAY ĐƯỢC NHIỀU YÊU THÍCH THƯỢNG HẠNG */}
//       <div className="flex items-end justify-between mb-8">
//         <div className="text-left">
//           <h2 className="font-classic text-2xl md:text-3xl font-bold text-[#2C1E15] mb-1">Được nhiều yêu thích nhất</h2>
//           <p className="text-xs text-gray-400">Những căn hộ gỗ được đánh giá tuyệt đối từ cộng đồng Cozygo</p>
//         </div>
//         <button 
//           onClick={() => setHasSearched(true)}
//           className="text-xs font-bold text-[#6E473B] hover:text-[#23150d] hover:underline whitespace-nowrap tracking-wider uppercase"
//         >
//           Xem tất cả bài đăng →
//         </button>
//       </div>
...
//         {[
//           { id: 10, name: "Mộc Lâm Đỉnh Villa", location: "Lạc Dương, Đà Lạt", price: "1,200,000", oldPrice: "1,800,000", rate: "4.9", orders: "142", img: "https://images.unsplash.com/photo-1510798831971-661eb04b3739?q=80&w=400&auto=format&fit=crop" },
//           { id: 11, name: "Nha Mộc Riêng Biệt", location: "Ninh Kiều, Cần Thơ", price: "650,000", oldPrice: "900,000", rate: "4.8", orders: "98", img: "https://images.unsplash.com/photo-1549693578-d683be217e58?q=80&w=400&auto=format&fit=crop" },
//           { id: 12, name: "Cozygo Lake House", location: "Hồ Tuyền Lâm, Đà Lạt", price: "2,100,000", oldPrice: "2,500,000", rate: "5.0", orders: "210", img: "https://images.unsplash.com/photo-1449034446853-66c86144b0ad?q=80&w=400&auto=format&fit=crop" },
//           { id: 13, name: "Nhà Tổ Chim Rừng Sâu", location: "Sapa, Lào Cai", price: "850,000", oldPrice: "1,200,000", rate: "4.7", orders: "64", img: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?q=80&w=400&auto=format&fit=crop" },
//         ].map(item => (
//           <HomestayCard 
//             key={item.id} 
//             item={item} 
...
//       {/* ==========================================
//           SECTION 1: KHÁM PHÁ VIỆT NAM (GIỮ NGUYÊN)
//          ========================================== */}
...
//       {/* ==========================================
//           SECTION 2: MỚI ĐỘC ĐÁO - GÓI TRẢI NGHIỆM BẢN ĐỊA (LOCAL EXPERIENCES)
//          ========================================== */}
...
//           <p className="text-xs text-gray-400">Thiết kế chuyến đi trọn vẹn hơn khi kết hợp lưu trú cùng các hoạt động mang đậm bản sắc địa phương</p>
//         </div>
...
//                   <button 
//                     onClick={() => setHasSearched(true)}
//                     className="text-[11px] font-bold text-[#2C3E2B] hover:underline"
//                   >
...
//       {/* ==========================================
//           SECTION 3: LỰA CHỌN THEO TÂM TRẠNG (GU NGHỈ DƯỠNG)
//          ========================================== */}
//       <section className="max-w-7xl mx-auto px-4 md:px-8 text-left">
//         <div className="mb-8">
//           <h2 className="font-classic text-2xl md:text-3xl font-bold text-[#2C1E15] mb-1">Lựa chọn theo tâm trạng</h2>
//           <p className="text-xs text-gray-400">Không chỉ là điểm đến, hãy chọn không gian phản chiếu đúng tâm hồn bạn lúc này</p>
//         </div>

//         <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
//           {[
//             { tag: "🌬️ Săn Mây Sáng Sớm", desc: "View ban công thung lũng sương", color: "bg-[#7d9f81]/10 text-[#2C3E2B] border-[#7d9f81]/30" },
//             { tag: "🔥 Lò Sưởi Đêm Đông", desc: "Không gian gỗ thông ấm cúng", color: "bg-[#6E473B]/10 text-[#6E473B] border-[#6E473B]/30" },
//             { tag: "🛶 Trốn Đời Cô Độc", desc: "Căn hộ biệt lập ẩn mình giữa bãi đá", color: "bg-amber-500/10 text-[#967205] border-amber-500/20" },
//             { tag: "🥩 Tiệc Nướng BBQ", desc: "Sân vườn thảm cỏ rộng cho gia đình", color: "bg-blue-500/10 text-blue-800 border-blue-500/20" }
//           ].map((gu, i) => (
//             <div 
//               key={i} 
//               onClick={() => setHasSearched(true)}
//               className={`p-5 rounded-2xl border cursor-pointer hover:scale-[1.02] hover:shadow-md transition-all duration-300 flex flex-col justify-between ${gu.color}`}
//             >
//               <span className="font-bold text-xs md:text-sm tracking-wide">{gu.tag}</span>
//               <span className="text-[11px] opacity-70 font-medium mt-4 block">➔ {gu.desc}</span>
//             </div>
//           ))}
//         </div>
//       </section>
...
//       {/* ==========================================
//           SECTION 4: HOMESTAY YÊU THÍCH NHẤT (GIỮ NGUYÊN)
//          ========================================== */}
//       <section className="max-w-7xl mx-auto px-4 md:px-8 text-left">
//         <div className="flex items-end justify-between mb-8">
//           <div>
...
//       {/* ==========================================
//           SECTION 5: REVIEW KHÁCH HÀNG (SOCIAL PROOF)
//          ========================================== */}
//       <section className="max-w-7xl mx-auto px-4 md:px-8 text-left">
//         <div className="mb-8">
//           <h2 className="font-classic text-2xl md:text-3xl font-bold text-[#2C1E15] mb-1">Nhật ký những bước chân ấm</h2>
//           <p className="text-xs text-gray-400">Những chia sẻ mộc mạc từ những người lữ hành đã chọn dừng chân tại hệ thống Cozygo</p>
//         </div>
...
//                 <div>
//                   <h4 className="text-xs font-bold text-[#2C1E15]">{rev.name}</h4>
//                   <p className="text-[10px] text-gray-400 font-medium">{rev.role} • <span className="text-[#6E473B] font-semibold">{rev.target}</span></p>
//                 </div>
//               </div>
//             </div>
//           ))}
