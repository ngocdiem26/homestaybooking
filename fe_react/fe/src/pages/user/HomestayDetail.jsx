...
//   // --- MOCK DATA (Trong thực tế, bạn sẽ dùng 'id' để gọi API fetch dữ liệu ở đây) ---
//   const homestay = {
//     id: id || "HS-01",
//     title: "GÂY THƯƠNG NHỚ Homestay (View Sông Lãng Mạn)",
//     location: "Vinhomes Grand Park, Quận 9, Hồ Chí Minh",
//     rating: 4.8,
//     reviewCount: 124,
...
//   // Lắng nghe sự kiện cuộn trang để active Tab tự động (Tùy chọn nâng cao)
//   useEffect(() => {
//     // Tích hợp API call tại đây: fetchHomestayDetails(id)
//     window.scrollTo(0, 0); // Reset scroll khi vào trang
//   }, [id]);
 
//   // Hàm chuyển đổi định dạng ngày YYYY-MM-DD sang DD/MM/YYYY (Đây là hàm đã thêm để fix lỗi)
//   const formatDmy = (dateStr) => {
//     if (!dateStr) return "";
//     const [y, m, d] = dateStr.split("-");
//     return `${d}/${m}/${y}`;
//   };
//   // Xử lý scroll mượt khi click Tab
//   const scrollToSection = (sectionId) => {
//     setActiveTab(sectionId);
//     const element = document.getElementById(sectionId);
//     if (element) {
//       // Trừ đi khoảng cách của thanh Header dính (sticky header)
//       const offset = 100; 
...
//       {/* 1. HEADER COZYGO (Đơn giản hóa cho trang chi tiết) */}
//        <div className="bg-[#2C3E2B] text-white p-4 sticky top-0 z-50 shadow-md">

//         {/* 1. THANH TÌM KIẾM ĐẶC TRƯNG COZYGO */}
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-2">
//           <div className="bg-[#3A2924] rounded-[32px] lg:rounded-full p-2.5 flex flex-col lg:flex-row items-center justify-between shadow-xl gap-3 lg:gap-4 relative z-20">
//             <div className="hidden lg:block pl-6 pr-3 py-2 border-r border-white/10">
//               <span className="text-white/80 font-black tracking-widest text-[11px] uppercase">Check Availability</span>
//             </div>
            
//             <div className="flex flex-col lg:flex-row flex-1 w-full gap-2.5">
//               {/* Điểm đến */}
//               <div className="bg-white rounded-full px-5 py-3 flex items-center gap-2.5 flex-1 cursor-text shadow-inner">
//                 <span className="text-rose-400 text-sm">📍</span>
//                 <input type="text" placeholder="Điểm đến ?" className="bg-transparent border-none outline-none text-sm w-full font-semibold text-gray-700 placeholder-gray-400" />
//               </div>
              
//               {/* Nhận phòng */}
//               <div className="bg-white rounded-full px-5 py-3 flex items-center gap-2.5 flex-1 cursor-pointer shadow-inner relative">
//                 <span className="text-blue-300 text-sm">📅</span>
//                 <input type="date" className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" />
//                 <span className="text-sm font-semibold text-gray-400">Nhận phòng</span>
//               </div>
...
//                 <span className="text-blue-300 text-sm">📅</span>
//                 <input type="date" className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" />
//                 <span className="text-sm font-semibold text-gray-400">Trả phòng</span>
//               </div>
...
//                   {[1,2,3,4,5,6].map(num => <option key={num} value={num}>{num} khách</option>)}
//                 </select>
//                 <span className="text-sm font-semibold text-gray-400">Số khách</span>
//               </div>
//             </div>

//             <button className="w-full lg:w-auto bg-[#6E473B] text-white font-black text-sm px-10 py-3.5 rounded-full hover:bg-[#57362C] transition-all active:scale-95 uppercase tracking-wider shadow-md">
//               Tìm kiếm
//             </button>
//           </div>
//         </div>
...
//         {/* 3. THƯ VIỆN ẢNH GRID CAO CẤP */}
//         <div className="grid grid-cols-1 md:grid-cols-4 gap-2.5 h-[300px] md:h-[460px] rounded-[32px] overflow-hidden shadow-sm">
...
//           </div>
//           <div className="hidden md:block cursor-pointer group relative overflow-hidden"><img src={homestay.images[1]} className="w-full h-full object-cover group-hover:scale-110 transition duration-700 ease-out" /></div>
//           <div className="hidden md:block cursor-pointer group relative overflow-hidden"><img src={homestay.images[2]} className="w-full h-full object-cover group-hover:scale-110 transition duration-700 ease-out" /></div>
//           <div className="hidden md:block cursor-pointer group relative overflow-hidden"><img src={homestay.images[3]} className="w-full h-full object-cover group-hover:scale-110 transition duration-700 ease-out" /></div>
//           <div className="hidden md:block cursor-pointer group relative overflow-hidden">
//             <img src={homestay.images[4]} className="w-full h-full object-cover brightness-75 group-hover:scale-110 group-hover:brightness-90 transition duration-700 ease-out" />
...
//         {/* 4. THANH ĐIỀU HƯỚNG NHANH (Sticky Tabs) */}
//         <div className="sticky top-[68px] z-40 bg-[#F4F1EA]/95 backdrop-blur-md pt-5 pb-3 border-b border-gray-300 mb-8 hidden md:block">
...
//                 className={`pb-3 border-b-[3px] transition-all duration-300 ${activeTab === tab ? 'border-[#2C3E2B] text-[#2C3E2B]' : 'border-transparent hover:text-gray-800'}`}
//               >
...
//                     <span className="bg-gray-100 px-3 py-1 rounded-lg">Tối đa {homestay.maxGuests} khách</span>
//                     <span className="bg-gray-100 px-3 py-1 rounded-lg">{homestay.bedrooms} phòng ngủ</span>
//                     <span className="bg-gray-100 px-3 py-1 rounded-lg">{homestay.beds} giường</span>
//                     <span className="bg-gray-100 px-3 py-1 rounded-lg">{homestay.bathrooms} phòng tắm</span>
//                   </p>
//                 </div>
...
//                 <button className="font-bold text-[#6E473B] underline text-sm mt-2 hover:text-[#2C1E15] transition">Đọc thêm chi tiết</button>
//               </div>
//             </div>
...
//                 ))}
//               </div>
//               <button className="mt-8 px-6 py-3 rounded-xl border-2 border-gray-300 font-bold text-sm hover:bg-gray-100 hover:border-gray-400 transition shadow-sm bg-white text-gray-700">
//                 Hiển thị tất cả 24 tiện nghi
//               </button>
//             </div>

//             {/* Đánh giá (Progress Bar chuẩn xịn) */}
...
//             <div className="sticky top-[140px] bg-white p-7 rounded-[32px] border border-gray-200 shadow-2xl shadow-[#2C1E15]/5">
...
//               <button className="w-full py-4 bg-[#2C3E2B] text-white rounded-2xl font-bold text-base shadow-lg shadow-[#2C3E2B]/20 hover:bg-opacity-90 hover:scale-[1.02] transition-all active:scale-[0.98]">
//                 Đặt phòng ngay
//               </button>
