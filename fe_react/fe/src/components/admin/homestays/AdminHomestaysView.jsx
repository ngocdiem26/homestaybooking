...
//                 options: HOMESTAY_STATUS_OPTIONS.map((option) => ({
//                   ...option,
//                   label: option.value === 'ALL' ? `${option.label} (${homestays.length})` : option.label,
//                 })),
//               },
//             ]}
...
//               onRefresh();
//             }}
//             searchPlaceholder="Tìm kiếm theo tên homestay, chủ nhà, địa chỉ..."
          ...
          <div className="bg-white rounded-2xl border border-gray-200/70 shadow-sm overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full border-collapse text-left text-base">
                <thead>
                  <tr className="bg-gray-50/70 border-b border-gray-200/60 text-gray-500 font-bold text-xs uppercase tracking-wider">
                    <th className="p-4 text-center w-[90px]">ID</th>
                    <th className="p-4">Căn hộ lưu trú</th>
                    <th className="p-4">Đối tác sở hữu</th>
                    <th className="p-4">Địa chỉ</th>
                    <th className="p-4 text-center">Trạng thái</th>
